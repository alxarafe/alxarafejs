...
| TD-02 | P0 | Abierta | CLI / Seguridad | La CLI ejecuta shell con interpolación de argumentos (`execSync`) y sin validar nombre ni confinar la ruta dentro de `modules/` | `packages/cli/src/helpers.ts:34`; `packages/cli/src/module.ts:47,192` |
